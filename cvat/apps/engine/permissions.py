            ...
            scopes.extend(
                cls.get_per_field_update_scopes(
                    request,
                    {
                        ...
                        "expertise_level": Scopes.UPDATE_PERSONAL_DATA,
                        ...
                        "institution": Scopes.UPDATE_PERSONAL_DATA,
                        "last_name": Scopes.UPDATE_PERSONAL_DATA,
                        "role": Scopes.UPDATE_PERSONAL_DATA,
                        "specialty": Scopes.UPDATE_PERSONAL_DATA,
...
class JobPermission(OpenPolicyAgentPermission, DownloadExportedExtension):
    ...
    def _get_scopes(cls, request: ExtendedRequest, view: ViewSet, obj: Job | None):
        ...
        scope = {
            ...
            ("sam3_models", "GET"): Scopes.VIEW,
            ("sam3_labels_sync", "POST"): Scopes.UPDATE_ANNOTATIONS,
            ("sam3_sessions", "POST"): Scopes.UPDATE_ANNOTATIONS,
            ("sam3_session_detail", "DELETE"): Scopes.UPDATE_ANNOTATIONS,
            ("sam3_video_sessions", "POST"): Scopes.UPDATE_ANNOTATIONS,
            ("sam3_video_session_detail", "DELETE"): Scopes.UPDATE_ANNOTATIONS,
            ("sam3_infer_text", "POST"): Scopes.UPDATE_ANNOTATIONS,
            ("sam3_infer_box", "POST"): Scopes.UPDATE_ANNOTATIONS,
            ("sam3_infer_points", "POST"): Scopes.UPDATE_ANNOTATIONS,
            ("sam3_video_prompt", "POST"): Scopes.UPDATE_ANNOTATIONS,
            ("sam3_video_propagate", "POST"): Scopes.UPDATE_ANNOTATIONS,
            ("sam3_video_remove_object", "POST"): Scopes.UPDATE_ANNOTATIONS,
            ("classifications", "GET"): Scopes.VIEW,
            ("classifications", "POST"): Scopes.UPDATE_ANNOTATIONS,
            ("classifications", "DELETE"): Scopes.UPDATE_ANNOTATIONS,
            ("partial_update", "PATCH"): Scopes.UPDATE,
            ("destroy", "DELETE"): Scopes.DELETE,
            ("annotations", "GET"): Scopes.VIEW_ANNOTATIONS,
            ("annotations", "PATCH"): Scopes.UPDATE_ANNOTATIONS,
            ...
            ("transcripts", "GET"): Scopes.VIEW,
            ("transcripts", "PATCH"): Scopes.UPDATE_ANNOTATIONS,
            ("data", "GET"): Scopes.VIEW_DATA,
            ("metadata", "GET"): Scopes.VIEW_METADATA,
            ("metadata", "PATCH"): Scopes.UPDATE_METADATA,
            ("initiate_dataset_export", "POST"): (
